...
pub const struct_dlist = extern struct {
    next: [*c]struct_dlist = @import("std").mem.zeroes([*c]struct_dlist),
    prev: [*c]struct_dlist = @import("std").mem.zeroes([*c]struct_dlist),
};
pub fn dlist_init(arg_list: [*c]struct_dlist) callconv(.C) void {
    var list = arg_list;
    _ = &list;
    list.*.next = list;
    list.*.prev = list;
}
pub fn dlist_insert_after(arg_list: [*c]struct_dlist, arg_new_node: [*c]struct_dlist) callconv(.C) void {
    var list = arg_list;
    _ = &list;
...
pub fn dlist_insert_before(arg_list: [*c]struct_dlist, arg_new_node: [*c]struct_dlist) callconv(.C) void {
    var list = arg_list;
    _ = &list;
    var new_node = arg_new_node;
    _ = &new_node;
...
pub fn dlist_remove(arg_list: [*c]struct_dlist) callconv(.C) void {
    var list = arg_list;
    _ = &list;
...
pub var free_chunk: [32]struct_dlist = @import("std").mem.zeroes([32]struct_dlist);
pub var mem_free: usize = 0;
pub var mem_used: usize = 0;
pub var mem_meta: usize = 0;
pub fn memory_chunk_slot(arg_size: usize) callconv(.C) usize {
    var size = arg_size;
    _ = &size;
...
pub export fn memory_pool_init(arg_mem: ?*anyopaque, arg_size: usize) void {
    var mem = arg_mem;
    _ = &mem;
    var size = arg_size;
    _ = &size;
...
pub export fn malloc(arg_size: usize) ?*anyopaque {
    var size = arg_size;
    _ = &size;
...
pub export fn free(arg_ptr: ?*anyopaque) void {
    var ptr = arg_ptr;
    _ = &ptr;
    if (!(ptr != null)) return;
...
pub inline fn ALIGN_UP(val: anytype, alignment: anytype) @TypeOf(((val + alignment) - @as(c_int, 1)) & ~(alignment - @as(c_int, 1))) {
    _ = &val;
    _ = &alignment;
    return ((val + alignment) - @as(c_int, 1)) & ~(alignment - @as(c_int, 1));
}
pub inline fn CHUNK_DATA(chunk_1: anytype) ?*anyopaque {
    _ = &chunk_1;
    return @import("std").zig.c_translation.cast(?*anyopaque, @import("std").zig.c_translation.cast([*c]struct_chunk, chunk_1) + @as(c_int, 1));
}
pub inline fn DATA_CHUNK(data: anytype) [*c]struct_chunk {
    _ = &data;
    return @import("std").zig.c_translation.cast([*c]struct_chunk, @import("std").zig.c_translation.cast([*c]struct_chunk, data) - @as(c_int, 1));
}
pub const NUM_SIZES = @as(c_int, 32);
pub const ALIGN = @as(c_int, 4);
pub const MIN_SIZE = ALIGN_UP(@import("std").zig.c_translation.sizeof(struct_dlist), ALIGN);
pub const dlist = struct_dlist;
pub const chunk = struct_chunk;
